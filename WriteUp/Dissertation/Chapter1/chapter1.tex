...
\begin{figure}[h!]
  \centering
    ...
    \caption{From left to right, the molar absorptivity, the absorption coefficient, and re-emittance of the four key chromophores. We assume a concentration of 150 $g/L$, which is typical of haemoglobin concentration in blood, and a unit path length. The remittance was found using Kubelka-Munk Theory, outlined in section \ref{sec:SkinColorSimulation}. }  \label{fig:ChemicalSpectralProperties}
\end{figure}
