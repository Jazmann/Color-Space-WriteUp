...
\begin{figure}[h]
  \centering
    \includegraphics[width=1.0\textwidth]{Chapter3/Figs/\individual/Fill_the_Bins.jpg}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=1.0\textwidth]{Chapter3/Figs/\individual/Top_and_Tail_the_Bins.jpg}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=1.0\textwidth]{Chapter3/Figs/\individual/Collapse_the_Bins.jpg}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=1.0\textwidth]{Chapter3/Figs/\individual/Fit_the_Gaussian1.jpg}
        \caption{The Gaussian fit to the blob}  \label{fig:Fit_the_Gaussian1}
    \end{figure}
