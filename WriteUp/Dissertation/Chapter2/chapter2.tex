...
\begin{align*}
 ...
 \check{\phi}_{a} (m) & < \overset{\times}{\phi} (2m)     <\check{\phi}_{b}(m)  < \overset{\times}{\phi} (2m+1)  <  \check{\phi}_{a} (m+1) & 
      \hat{\phi}_{a}(m) & < \overset{\times}{\phi} (2m+1) <    \hat{\phi}_{b}(m)  < \overset{\times}{\phi} (2m+2)  <      \hat{\phi}_{a}(m+1) 
\end{align*}
