...
%\end{gather*}
 ...
 \begin{algorithmic}
      ...
      \State \textbf{Return} {$\thetaX{i}$}\Comment{$\thetaX{i} $ the angular position of the intercept and the maximum perturbation at that value}
\EndFunction
 \end{algorithmic}
\end{algorithm}
...
\begin{algorithm}[H]
 ...
 \begin{algorithmic}
  ...
  \linebreak \phantom{Require} { $\theta$ the requested angle; \quad \quad $\tau$ the tolerance}
