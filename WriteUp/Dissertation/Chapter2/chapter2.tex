...
\begin{array}{ccc}
 1 & 1 & 1 \\
 \left(\theta -\frac{5 \pi }{6}\right) \sin  & \left(\theta +\frac{3 \pi }{6}\right) \sin  & \left(\theta -\Pii{6}\right) \sin  \\
 \left(\theta -\frac{2 \pi }{6}\right) \sin  & \left(\theta -\frac{6 \pi }{6}\right) \sin  & \left(\theta +\frac{2 \pi }{6}\right) \sin  \\
\end{array}
\right)
\end{equation}
