...
\newcommand{\extremaTheta}[1]{\hat{\check{\phi}}_{#1}}
...
The following ranges are guaranteed to be true for all values of $m$ and $n$.
\begin{align*}
...
%
%\begin{align*}
%\overset{\times}{\phi} (i)  \in & \begin{cases}
%\begin{array}{cc}
% \hat{\phi}_{b}(\frac{i}{2}-1) &\gtrless \\
%  \check{\phi}_{a} (\frac{i}{2}) & < 
%\end{array}
...
\begin{align*}
T ( \tau , m )  = & \begin{cases}
\tau\ge\frac{ \extremaTheta{b}(i) -  \extremaTheta{a}(i) }{\| \extremaTheta{b}(i-1)- \extremaTheta{a}(i+1)  \| +\extremaTheta{b}(i) -  \extremaTheta{a}(i)  } & 
i \in \{ 2 \mathbb{N} \} \\
\tau\ge\frac{\| \extremaTheta{b}(i-1) - \extremaTheta{a}(i+1) \| }{ \| \extremaTheta{b}(i-1) - \extremaTheta{a}(i+1) \| + \extremaTheta{b}(i) - \extremaTheta{a}(i) } & 
i \in \{ 2 \mathbb{N} +1 \}
\end{cases}
\end{align*}
...
\begin{align*}
T ( \tau , m )  = & \begin{cases}
\tau\ge\frac{\check{\phi}_{a}(m)  - \check{\phi}_{b}(m) }{\| \hat{\phi}_{b}(m-1) - \hat{\phi}_{a}(m) \| +\check{\phi}_{a}(m)  - \check{\phi}_{b}(m) } & 
m \in \{ 2 \mathbb{N} \} \\
\tau\ge\frac{\| \check{\phi}_{b}(m)  - \check{\phi}_{a} (m+1) \| }{ \hat{\phi}_{a}(m)  - \hat{\phi}_{b}(m)+\| \check{\phi}_{b}(m)  - \check{\phi}_{a} (m+1) \| } & 
m \in \{ 2 \mathbb{N} +1 \}
\end{cases}
\end{align*}
...
\begin{equation}\label{eq:disFunction}
  dis(x) = \frac{(\yRange) \left(\text{erf}\left(\frac{x-\mu }{\sqrt{2} \sigma }\right)-\text{erf}\left(\frac{\xMin-\mu }{\sqrt{2} \sigma }\right)\right)}{\text{erf}\left(\frac{\tMax-\mu }{\sqrt{2} \sigma }\right)-\text{erf}\left(\frac{\xMin-\mu }{\sqrt{2} \sigma }\right)}+\yMin
\end{equation}
