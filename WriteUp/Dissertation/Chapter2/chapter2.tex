...
\raisebox{-13mm}{\includegraphics[width = 26mm]{Chapter2/Figs/fRWheel.jpg}} & Scale : $fS[\delta\theta]$ &  Factored Rotation : $fR[\delta\theta]$ \\ 
\hline \rule[-2ex]{0pt}{5.5ex} \bf{A} & \( \left(\!\!\!

\begin{array}{c}
 1 \\
 \cosine {\delta\theta } \\
 \cosine{\Pii{6}-\delta\theta } \\
\end{array}
