...
\begin{array}{ccc}
 0 & 0 & 0 \\
 2^{2-n} \text{Round}\left[2^{n-2} \text{fRe}(\delta \theta )\right]-\text{fRe}(\delta \theta ) & 0 & 2^{2-n} \text{Round}\left[2^{n-2} \text{fRe}(-\delta \theta )\right]-\text{fRe}(-\delta \theta ) \\
 2^{2-n} \text{Round}\left[2^{n-2} \text{fRe}\left(\frac{\pi }{6}-\delta \theta \right)\right]-\text{fRe}\left(\frac{\pi }{6}-\delta \theta \right) & 2^{2-n} \text{Round}\left[2^{n-2} \text{fRe}\left(\delta \theta -\frac{\pi }{6}\right)\right]-\text{fRe}\left(\delta \theta -\frac{\pi }{6}\right) & 0 \\
\end{array}
\right)
\end{align}
...
The perturbation introduced to each channel is further simplified by recognising that $err(-\phi)=-err(\phi)$.

which allows us to analyse the quantization error in terms of just one function $err$.
