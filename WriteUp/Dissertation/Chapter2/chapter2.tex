...
\begin{align*}
\qRsMin     &= \left( \begin{smallmatrix}  0           \\  -2^{2n-1}  \\ -2^{2n-1} \\ \end{smallmatrix} \right) & 
\qRsMax    &= \left( \begin{smallmatrix}  2^{n+2} \\    2^{2n-1}  \\   2^{2n-1} \\ \end{smallmatrix} \right) & 
\qRsRange &= \left( \begin{smallmatrix}  2^{n+2} \\    2^{2n}      \\   2^{2n}     \\ \end{smallmatrix} \right) 
\end{align*}
