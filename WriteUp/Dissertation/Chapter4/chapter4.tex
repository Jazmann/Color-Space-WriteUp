...
\subsection{The White-Out Black-Out Algorithm}
...
\begin{algorithm}[H]
 ...
 slack(Cb_{min}) \le Cb \le  slack(Cb_{max})
  ...
  \subsection{The Color Space Algorithm as Implemented}
