...
\includegraphics[width=0.8\textwidth]{Chapter4/Figs/EllipticalFitTestFull.jpg}
\label{fig:EllipseFitTestFull}}
\qquad
\subfloat[The AMS method sometimes produces a hyperbolic fit.][The AMS method sometimes produces a hyperbolic fit whilst the direct metod always probuces an ellipse]{
\includegraphics[width=0.4\textwidth]{Chapter4/Figs/EllipticalFitTest_Hyperbolic.jpg}
...
\includegraphics[width=0.4\textwidth]{Chapter4/Figs/EllipticalFitTest_DTA.jpg}
