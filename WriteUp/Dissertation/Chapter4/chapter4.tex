...
\subsubsection{Finding the frame orientation}
\subsubsection{Finding the end of the finger shape}
\subsubsection{Filament fill the finger}
\subsubsection{Exclude Secondary Frame Edge Points and Fingertip Points }
\begin{figure}[h!]
  \centering
...
\subsubsection{Kink Fit to the Finger}

\subsubsection{Parallel Lines Fit}
