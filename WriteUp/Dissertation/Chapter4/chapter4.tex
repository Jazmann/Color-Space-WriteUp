...
\begin{figure}[h!]
  \centering
    ...
    \caption{Example of the KinkFit algorithm in action, showcasing its reliability over several iterations.}\label{fig:KinkFitC}
\end{figure}
...
\begin{figure}[h!]
  \centering
    ...
    \caption{Example of the KinkFit algorithm in action, showcasing its reliability over several iterations.}\label{fig:KinkFitF}
\end{figure}
...
\begin{figure}[h!]
  \centering
    ...
    \caption{Example of the KinkFit algorithm in action, showcasing its reliability over several iterations.}\label{fig:KinkFitH}
\end{figure}
...
\begin{figure}[h!]
  \centering
    ...
    \caption{Example of the KinkFit algorithm in action, showcasing its reliability over several iterations.}\label{fig:KinkFitK}
\end{figure}
