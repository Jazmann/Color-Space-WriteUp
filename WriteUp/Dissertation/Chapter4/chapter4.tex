...
The position is found by finding the average of the vectors; the orientation is found by taking the product of the distance from the position to the point on the model with the residual of the 'force' vector, and summing over all the points on the model. This gives a total moment about the position which translates to an orientation.
...
\subsubsection{Smooth Motion Dynamic Tracking}\label{sec:SmoothMotionDynamicTracking}
