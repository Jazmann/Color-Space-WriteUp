...
Polygon[Flatten[{trap[[1]],{elpse[[1]]},Reverse[trap[[2]]]},1]],
...
ellipse[{xy_, ab_, \[Phi]_},{\[Phi]1_,\[Phi]2_},"Open",opts:OptionsPattern[ellipse]]:=ellipse[xy, ab, \[Phi],{\[Phi]1,\[Phi]2},"Open",opts];
ellipse[xy_, ab_, \[Phi]_,{\[Phi]1_,\[Phi]2_},"Closed",OptionsPattern[ellipse]]:=Module[{res,fun,pnts,partition,\[Psi]1,\[Psi]2},
  res=OptionValue[Resolution];
  \[Psi]1 = \[Phi]1; \[Psi]2 = If[\[Phi]2<\[Phi]1, \[Phi]2 +2 Pi, \[Phi]2];
  fun=paramEllipseFunction[{xy, ab, \[Phi]}];
  pnts=Table[fun[\[Psi]1+k (\[Psi]2-\[Psi]1)/res],{k,0,res}];
  If[(\[Psi]2-\[Psi]1)>=2Pi,
...
ellipse[xy_, ab_, \[Phi]_,{\[Phi]1_,\[Phi]2_},"Open",OptionsPattern[ellipse]]:=Module[{res,fun,pnts,partition,\[Psi]1,\[Psi]2},
  res=OptionValue[Resolution];
  \[Psi]1 = \[Phi]1; \[Psi]2 = If[\[Phi]2<\[Phi]1, \[Phi]2 +2 Pi, \[Phi]2];
  fun=paramEllipseFunction[{xy, ab, \[Phi]}];
  pnts=Table[fun[\[Psi]1+k (\[Psi]2-\[Psi]1)/res],{k,0,res}];
